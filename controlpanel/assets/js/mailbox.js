! function(document, window, $) {
    ...
    window.AppMailbox = App.extend({
        handleAction: function() {
            ...
            }), $('[data-action="trash"]', ".site-action").on("click", function() {}), $('[data-action="inbox"]', ".site-action").on("click", function() {}), $selectable.on("asSelectable::change", function(e, api, checked) {
        ...
        initMail: function() {
            var self = this;
            $.getJSON("http://mailbord.azurewebsites.net/api/mail", function(data) {
        ...
        handlSlidePanelPlugin: function() {
            if ("undefined" != typeof $.slidePanel) {
                var self = this,
                    defaults = $.components.getDefaults("slidePanel"),
        ...
        run: function(next) {
            this.handleAction(), this.handleListItem(), this.initMail(), $("#addlabelForm").modal({
                show: !1
            }), $("#addMailForm").modal({
                show: !1
