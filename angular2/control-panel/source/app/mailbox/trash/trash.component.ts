...
export class TrashComponent implements OnInit {
  ...
  public messages: any;
    ...
    this.mailboxService.getAllMessages('trash').subscribe(
      data => {
  ...
  deleteFromTrash (message: any){
    this.delete(this.messages, message);
    this.mailboxService.deleteForEver(message)
      .subscribe(
        data => {
          this.alertService.popSuccess('Email has been deleted successfully!')
        },
        error => {
          console.log(error);
